            ...
            <div className="container mx-auto">
                ...
                <div className="flex flex-col items-center text-center">
                    ...
                    <p className="subtitle">
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Laborum cumque necessitatibus in quia consequuntur deserunt consectetur ipsum voluptatum provident excepturi?
                    </p>
                </div>
                {/* item grid */}
